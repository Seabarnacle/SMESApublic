# SMESA supporting information

This repository contains the modified Psi4 source and supporting calculations
for **“Secondary Minimal Error Sampling Algorithms for Accelerating
Self-Consistent Field Calculations”** by Paul Calistrate-Petre and Yan Alexander
Wang. See [`mesa/SMESACASES/README.md`](mesa/SMESACASES/README.md) for software
provenance, portable build and calculation instructions, case-file conventions,
the internal-to-paper method-name maps, the JSON schema and units.

The modified implementation is based on Psi4 1.9. The original Psi4 project
README is retained below because the complete source snapshot is part of the
