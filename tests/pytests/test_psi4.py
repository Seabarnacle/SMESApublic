...
def test_psi4_basic_mesa():
    ...
    options = {
        ...
        'MESA_SCF_METHODS': ["EDIIS" , "LISTB", "LISTF", "LISTR", "ADIIS", "DIIS", "FDIIS"],
        "basis": "cc-pVDZ"
    }
...
@pytest.mark.smoke
def test_psi4_perturbed_listr():
    """sih4-energy"""
    #! Sample HF/6-31G* SiH3-H computation

    sih4 = psi4.geometry("""
    SI      
    H             1    4.040571
    H             1    1.471547      2  107.230629
    H             1    1.471547      2  107.230629      3  120.000000
    H             1    1.471547      2  107.230629      3 -120.000000
    """)
    options = {
    "LIST": "LISTR",
    ...
    assert psi4.compare_values(-290.97348711113830, psi4.variable('SCF TOTAL ENERGY'), 6, 'SCF energy')

@pytest.mark.smoke
def test_psi4_perturbed_listf():
    """sih4-energy"""
    #! Sample HF/6-31G* SiH3-H computation
