...
void export_wavefunction(py::module& m) {
    ...
    py::class_<Wavefunction, std::shared_ptr<Wavefunction>>(m, "Wavefunction", "docstring", py::dynamic_attr())
        ...
        .def("Ja", &Wavefunction::Ja, "Returns the Potential Matrix.")
        .def("Jb", &Wavefunction::Jb, "Returns the Potential Matrix.")
    ...
    py::class_<scf::HF, std::shared_ptr<scf::HF>, Wavefunction>(m, "HF", "docstring")
        ...
        .def("form_FoutmFin", &scf::HF::form_FoutmFin, "Forms the difference between Fock Matrices")
        .def("form_MaddM", &scf::HF::form_MaddM, "Adds two matrices together.")
        .def("form_XMX", &scf::HF::form_XMX, "Project into orthogonal basis.")
