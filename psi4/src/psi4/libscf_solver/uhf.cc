...
void UHF::common_init() {
    ...
    Ja_ = SharedMatrix(factory_->create_matrix("J alpha"));
    Jb_ = SharedMatrix(factory_->create_matrix("J beta"));
...
void UHF::form_G() {
    ...
    Ja_->copy(J[0]); //potential matrixes for list and mesa
    Jb_->copy(J[1]);
...
void UHF::form_F() {
    ...
    //Ja_->copy(J_); //potential matrixes for list and mesa
    //Jb_->copy(J_);
